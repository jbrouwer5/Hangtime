...
void evidence_place_piece()
{
    ...
    board_show(game9->b);
    place_piece(game9, make_pos(1,0));
    board_show(game9->b);
    place_piece(game9, make_pos(2,2));
    board_show(game9->b);
    place_piece(game9, make_pos(2,0));
    board_show(game9->b);

    if (game_outcome(game9) == WHITE_WIN)
    {
        printf("WHITE_WIN\n"); 
    }
    else if (game_outcome(game9) == BLACK_WIN)
    {
        printf("BLACK_WIN\n"); 
    }
    else if (game_outcome(game9) == DRAW)
    {
        printf("DRAW\n"); 
    }
    else
